			...
			<div class="fol-sm-12">
				...
				<form class="form-horizontal" name="writingFrm" id="writingFrm" action="ZIMZALABIM/detail/detail.do" method="post">
					...
					<div class="form-group">
						<label class="col-sm-1 control-label"></label>
						<diV class="col-sm-9">
			    			<input type="button"  class="btn btn-default btn-sm  btn-warning btn-hover" value="수정" id="update_btn" />
			    			<input type="button"  class="btn btn-default btn-sm  btn-warning btn-hover" value="취소" id="cancel_btn" />
						</div>			
					</div>
   					<!--// button area -->										
			</div>
