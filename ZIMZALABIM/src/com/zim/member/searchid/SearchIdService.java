 /**
 * @Class Name : SearchIdService.java
 * @Description : 
...
public class SearchIdService {
	...
	public MessageVO do_searchId(MemberVO inVO){
		MessageVO outVO = new MessageVO();
		MemberVO tmpVO = (MemberVO) memberDao.do_selectOne_ckId(inVO);
		if(tmpVO==null){
			...
			outVO.setMsgContents("회원님의 아이디는 "+tmpVO.getUserId()+"입니다.");
			return outVO;
		}
	}
