...
<!-- 						// 아이디 -->
					...
					<div class="form-group">
						...
						<diV class="col-sm-4">
							<input type="text" name="target_cnt" id="target_cnt" value="<%=targetCnt%>" class="form-control input-sm" autocomplete="off" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
						</div>	
					...
					<div class="form-group">
						...
						<diV class="col-sm-4">
							<input type="text" name="price" id="price" value="<%=price%>" class="form-control input-sm" autocomplete="off" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
						</div>	
						<label class="col-sm-1 control-label">배송비</label>
						<diV class="col-sm-3">
							<input type="text" name="delivery_price" value="<%=deliveryPrice%>" id="delivery_price" class="form-control input-sm" autocomplete="off" onkeyup="this.value=this.value.replace(/[^0-9]/g,'')"/>
						</div>		
					</div>
					<!--// 가격, 배송비 -->
...
<!-- 							<textarea name="contents" id="contents" rows="10" cols="100"></textarea>							 -->
					...
					<div class="form-group">
						<label class="col-sm-1 control-label"></label>
						<diV class="col-sm-8">
<!-- 							<input type="button"  class="btn btn-warning btn-hover" value="등록" id="save_btn" /> -->
<!-- 			    			<input type="button"  class="btn btn-warning btn-hover" value="수정" id="update_btn" /> -->
<!-- 			    			<input type="button"  class="btn btn-warning btn-hover" value="취소" id="cancel_btn" /> -->
							<%if(flag.equals("insert")){ //flag가 insert이면%>
							<input class="btn btn-warning btn-hover" type="button" id="save_btn" value="등록"/>
							<%}else if(flag.equals("update")){ //flag가 update이면%>
							<input class="btn btn-warning btn-hover" type="button" id="update_btn" value="수정"/>
							<%} %>
		              		<input class="btn btn-warning btn-hover" type="button" id ="cancel_btn" value="취소"/>
						</div>			
					</div>
   					<!--// button area -->										
				</form>				
